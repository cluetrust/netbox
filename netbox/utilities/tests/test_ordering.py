...
class NaturalizationTestCase(TestCase):
    ...
    def test_naturalize_interface(self):
        ...
        data = (
            ...
            ('Gi1:2', '9999999999999999Gi000001000002      '),
            ('Gi1:2.3', '9999999999999999Gi000001000002000003'),
            # modern Junos
            ('lo0', '9999999999999999lo000000            '),
            ('vlan0', '9999999999999999vlan000000            '),
            ('vlan0.0', '9999999999999999vlan000000      000000'),
            ('ge-0/0/20', '0000000099999999ge-000020            '),
            ('ge-0/0/20.0', '0000000099999999ge-000020      000000'),
            ('ge-0/0/20.1', '0000000099999999ge-000020      000001'),
            ('xe-2/3/20.1', '0002000399999999xe-000020      000001'),
            # Generic
    ...
    def test_naturalize_interface_colission(self):
        self.assertNotEqual(naturalize_interface('ge-0/0/20', max_length=100),
                            naturalize_interface('ge-0/0/20.1', max_length=100))
